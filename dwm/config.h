...
static const Key keys[] = {
    ...
    { MODKEY,                       XK_w,           spawn,       SHCMD("mullvad-browser") },
    { MODKEY,                       XK_t,           spawn,       SHCMD("tor-browser") },
    { MODKEY|ShiftMask,             XK_t,           spawn,       SHCMD("mullvad-exclude thorium-browser") },
    { MODKEY|ShiftMask,             XK_s,           spawn,       SHCMD("mullvad-exclude spotify") },
    { MODKEY|ShiftMask,             XK_m,           spawn,       {.v = mail } },
    { MODKEY|ControlMask,           XK_j,           spawn,       SHCMD("exec com.github.iwalton3.jellyfin-media-player") },
    { MODKEY|ControlMask,           XK_f,           spawn,       SHCMD("freetube") },
...
/*    { MODKEY,                       XK_l,           spawn,       SHCMD("betterlockscreen --lock blur") },*/
    ...
    { MODKEY,             XK_r,           spawn,       SHCMD("alacritty -e pyradio") },
